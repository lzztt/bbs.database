-- mysqldump -u root -p --opt --no-data --compatible=postgresql --default-character-set=utf8 --set-charset hbbs > ~/www.houstonbbs.com/db/schema.pg.sql
--
...
CREATE TABLE "comments" (
  ...
  KEY "nid" ("nid"),
  KEY "uid" ("uid"),
  KEY "lastModifiedTime" ("last_modified_time"),
  KEY "tid" ("tid"),
  KEY "hash" ("hash")
);
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE "users" (
  ...
  KEY "accessTime" ("last_access_time"),
  KEY "type" ("type"),
  KEY "role" ("role")
);
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2013-12-13 21:54:16
